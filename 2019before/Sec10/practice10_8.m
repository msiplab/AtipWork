% practice10_8.m
%
% $Id: practice10_8.m,v 1.2 2007/05/07 11:09:47 sho Exp $
%
...
while(hasFrame_)
    ...
    deintPicture0(1:2:end,:) = ...
        ...
        + 1/2 * [ pictureI(2,:) ;...
                  pictureI(2:2:end-2,:)];
    mvField = ...
        fullSearchBlockMatchingMe(deintPicture1, deintPicture0, me);
    predictedPicture = ...
    ...
    deintPicture1(2:2:end,:) = ...
        ...
        + 1/2 * [ pictureI(3:2:end,:) ;...
                  pictureI(end-1,:)];    
    mvField = ...
        fullSearchBlockMatchingMe(deintPicture0, deintPicture1, me);
    predictedPicture = ...
