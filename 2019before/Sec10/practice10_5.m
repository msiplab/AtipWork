% practice10_5.m
%
% $Id: practice10_5.m,v 1.6 2007/05/07 11:09:47 sho Exp $
%
...
while(hasFrame_)
    ...
    deintPicture0(1:2:end,:) = threeNeighborMedian(...
            pictureI(2:2:end,:),...
            previousField,...
            [pictureI(2,:) ; ...
             pictureI(2:2:end-2,:)] );
    ...
    deintPicture1(2:2:end,:) = threeNeighborMedian(...
            pictureI(1:2:end,:),...
            previousField,...
            [pictureI(3:2:end,:,:) ; ...
             pictureI(end-1,:,:)] );
