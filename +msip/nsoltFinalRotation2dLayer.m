classdef nsoltFinalRotation2dLayer < nnet.layer.Layer
    ...
    methods
        ...
        function Z = predict(layer, X)
            ...
            W0T = transpose(layer.fcn_orthmtxgen_(anglesW,muW));
            U0T = transpose(layer.fcn_orthmtxgen_(anglesU,muU));
        ...
        function [dLdX, dLdW] = ...
            ...
            % dLdX = dZdX x dLdZ
            W0 = layer.fcn_orthmtxgen_(anglesW,muW,0);
            U0 = layer.fcn_orthmtxgen_(anglesU,muU,0);
            ...
            for iAngle = 1:nAngles/2
                dW0_T = transpose(layer.fcn_orthmtxgen_(anglesW,muW,iAngle));
                dU0_T = transpose(layer.fcn_orthmtxgen_(anglesU,muU,iAngle));
