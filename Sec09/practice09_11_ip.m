% practice09_11.m
%
% $Id: practice09_11_ip.m,v 1.2 2007/05/07 11:09:47 sho Exp $
%
...
%% 画像の読込
pictureOriginal = rgb2gray(imread('./data/barbaraFaceRgb.tif'));

%% 原画像
figure(1)
imshow(pictureOriginal)
